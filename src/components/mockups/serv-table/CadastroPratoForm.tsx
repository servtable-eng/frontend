...
export function CadastroPratoForm() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.posicao)          e.posicao   = 'Selecione a posição da cuba.';
    if (!form.preco.trim())     e.preco     = 'Informe o preço interno.';
    setErrors(e);
      ...
      <main style={{ flex: 1, overflowY: 'auto', paddingBottom: 88 }}>
        <div style={{ maxWidth: 1000, margin: '0 auto', padding: '36px 40px', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, color: '#6B7280' }}>
              <a href="#" style={{ color: '#6B7280', textDecoration: 'none' }}>Cardápio</a>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div style={card}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  ...
                  <div>
                    <FieldLabel required>Posição da Cuba</FieldLabel>
                    <Select
                      options={CUBA_OPTS}
                      value={form.posicao}
                      onChange={(e: ChangeEvent<HTMLSelectElement>) => set('posicao', e.target.value)}
                      error={errors.posicao}
                    />
                    <FieldError msg={errors.posicao} />
                    <p style={{ margin: '5px 0 0', fontSize: 12, color: '#6B7280', fontFamily: 'Inter, system-ui, sans-serif' }}>
                      Ordem de exibição no buffet.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div style={card}>
                ...
                <div style={section}>
                  <div>
                    ...
                    <div style={{ maxWidth: 220 }}>
                      <Input
                        placeholder="R$ 0,00"
                        value={form.preco}
                        onChange={(e: ChangeEvent<HTMLInputElement>) => set('preco', e.target.value)}
                        error={errors.preco}
                      />
                    </div>
                    <p style={{ margin: '5px 0 0', fontSize: 12, color: '#6B7280', fontFamily: 'Inter, system-ui, sans-serif' }}>
                  ...
                  <div style={{ paddingTop: 12, borderTop: '1px solid #EAE4DF', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <Toggle checked={form.disponivel} onChange={() => set('disponivel', !form.disponivel)} />
                  </div>
                </div>
              </div>
            </div>
                ...
                {form.imagemUrl ? (
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <p style={{ margin: '3px 0 0', fontSize: 12, color: '#6B7280' }}>PNG, JPG ou WEBP · máx. 5 MB</p>
                    </div>
                  </div>
                )}
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <Button variant="primary"   size="md" onClick={handleSave}>Salvar prato</Button>
          </div>
        </div>
      </main>
    </div>
