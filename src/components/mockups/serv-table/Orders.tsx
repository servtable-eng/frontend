import { Home, ClipboardList, BookOpen, BarChart2, Settings, UtensilsCrossed, Clock } from 'lucide-react';
import './_shared/tokens.css';

const NAV_ITEMS = [
  { icon: Home, label: 'Início', active: false },
  { icon: ClipboardList, label: 'Pedidos', active: true },
...
export function Orders() {
  return (
    <div className="serv-theme flex min-h-screen serv-bg-background w-full overflow-hidden">
      {/* Sidebar */}
